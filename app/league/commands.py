...
FLASK_ROOT = os.path.join(HERE, os.pardir)
PROJECT_ROOT = os.path.join(FLASK_ROOT, os.pardir)
TEST_PATH = os.path.join(FLASK_ROOT, 'tests')
...
def lint(fix_imports):
    ...
    root_dir = os.path.join(PROJECT_ROOT, 'app')
